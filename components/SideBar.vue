            ...
            <div class="flex flex-col justify-between flex-1 mt-8">
                <div class="space-y-4 flex-grow-0">
                    <nav class="flex-1 space-y-2">
                        ...
                        <NuxtLink to="/devices" title="" :class="{'bg-indigo-50 text-blue-600 mx-5 rounded-lg' : isActive('/devices/group')}" class="flex items-center px-4 py-3 text-sm font-medium text-gray-900 transition-all duration-200 hover:bg-gray-200 group">
