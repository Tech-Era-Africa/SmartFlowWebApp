            ...
            <form action="#" method="POST" class="mt-4">
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="email" name="" id="" placeholder="Email address" value="" class="border block w-full px-4 py-3 placeholder-gray-500 border-gray-300 rounded-lg focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm caret-indigo-600" />
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" title="" class="text-sm font-medium text-indigo-600 hover:text-indigo-700"> Forgot Password? </a>
                        </div>
                        <div class="mt-2">
                            <input type="password" name="" id="" placeholder="Password (min. 8 character)" value="" class="border block w-full px-4 py-3 placeholder-gray-500 border-gray-300 rounded-lg focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm caret-indigo-600" />
                        </div>
                    </div>

                    <div class="relative flex items-center">
                        <div class="flex items-center h-5">
                            <input type="checkbox" name="remember-password" id="remember-password" class="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-600" />
                        </div>
